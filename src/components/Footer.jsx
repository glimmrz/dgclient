  ...
  return (
    <div className="footer-2">
      <div className="container">
        <div className="footer__wrapper footer-wrap">
          <h1
            data-w-id="8d8766e3-2749-093c-6cdd-8c088828d5f8"
            style={{ opacity: 0 }}
            className="heading-5"
          >
            {isFrench
              ? "Nous croyons que DesignJoy.ch est le choix parfait pour vos besoins."
              : "We believe DesignJoy.ch is the perfect fit for your needs."}
          </h1>
          <p
            data-w-id="c50a6184-8e34-64d9-e902-7e44828e6215"
            style={{ opacity: 0 }}
            className="inline"
          >
            {isFrench
              ? "Nous servons des individus et des entreprises exigeants à travers la Suisse. Découvrez DesignJoy pour explorer comment vous pouvez révolutionner votre présence en ligne."
              : "We serve discerning individuals and businesses throughout Switzerland. Take a guided tour of DesignJoy to explore how you can revolutionize your online presence."}
          </p>
          <div className="button__wrapper">
            <a
              href="#plans"
              data-w-id="c6288447-6c4a-d637-39e8-3980fec408ae"
              style={{ opacity: 0 }}
            ...
            <div className="w-layout-grid footer_top-wrapper">
              <div className="w-layout-grid footer_menu-wrapper">
                <div className="footer_link-list">
                  ...
                  <a href="https://www.DesignJoy.ch" className="footer_link">
                ...
                <div className="footer_link-list">
                  <div className="margin-bottom-2 margin-xsmall">
                    <div className="footer_heading">
                      {isFrench ? "Réseaux sociaux" : "Socials"}
                    </div>
                  </div>
                  <a
              ...
              <div className="footer_left-wrapper">
                <div className="margin-bottom-2 margin-small">
                  <div className="text-style-muted">
                    {isFrench
                      ? "Abonnez-vous à notre newsletter pour rester informé de toutes les nouvelles et opinions sur les médias payants"
                      : "Join our newsletter to stay up to date on all paid media news and opinion"}
                  </div>
                </div>
                <div className="footer_form-block w-form">
                  ...
                  >
                    <input
                      ...
                      placeholder={
                        isFrench ? "Entrez votre email" : "Enter your email"
                      }
                      type="email"
                      id="Email-Form-2"
                      required=""
          ...
          <div className="padding-top padding-medium">
            <div className="footer_bottom-wrapper">
              <div className="footer_credit-text">
                {isFrench
                  ? "©️ 2024 Copyright Concorde SA Conseil en Entreprises t/a DesignJoy.ch"
                  : "©️ 2024 Copyright Concorde SA Conseil en Entreprises t/a DesignJoy.ch"}
              </div>
              <div className="w-layout-grid footer_legal-list">
                <a href="/privacy-policy" className="footer_legal-link">
                  {isFrench ? "Politique de confidentialité" : "Privacy Policy"}
                </a>
                <a href="/terms-of-service" className="footer_legal-link">
                  {isFrench ? "Conditions de service" : "Terms of Service"}
                </a>
                <a href="/cookies" className="footer_legal-link">
                  {isFrench ? "Paramètres des cookies" : "Cookies Settings"}
                </a>
              </div>
            </div>
          </div>
